const responces = [
    ...
    Responce("emu", "ichika", "れっつわんだほーい！", "わ、わんだほーい…！"),
    Responce("ichika", "nene", "うまく歌えてるかな？", "うん、わたしは好きだな…"),
    Responce("nene", "ichika", "ほ、星乃さん、一緒に…", "うん…！ 一緒に歌おう！"),
    ...
    Responce("saki", "tsukasa", "この勢いで頑張るね！", "ふっ！ 流石は我が妹！"),
    Responce("tsukasa", "saki", "まだまだ盛り上げるぞ！", "いけいけー！ お兄ちゃーん！"),
    ...
    Responce("honami", "emu", "えむちゃん楽しそうだね！", "えへへ、穂波ちゃんも！"),
    Responce("emu", "honami", "穂波ちゃん、わんだほーい！", "わ…わんだほーい！"),
    Responce("honami", "nene", "素敵な歌声ですね！", "え、あ、ありがとう…"),
    Responce("nene", "honami", "望月さんのドラム、歌いやすい…", "この調子でサポートしますね！"),
    ...
    Responce("shiho", "shizuku", "その調子。が、頑張って…", "しぃちゃん…！"),
    Responce("shizuku", "shiho", "しぃちゃんと一緒で嬉しいわ！", "分かったから、よそ見しない"),
    Responce("shiho", "emu", "いい調子じゃん！", "志歩ちゃんもキラキラ笑顔だね！"),
    Responce("shiho", "nene", "歌、しっかり響いてるね！", "これだけは負けたくないから…"),
    Responce("nene", "shiho", "日野森さん、いい音出てるね", "生半可な練習、してないからね"),
    ...
    //tsukasa
    Responce("tsukasa", "emu", "見ろ！ みんなの笑顔を！", "あたしも思わずわんだほーい！"),
    Responce("tsukasa", "nene", "ふっ、オレを呼ぶ歓声が聞こえる！", "耳、大丈夫？"),
    Responce("nene", "tsukasa", "しっかり合わせてよ？", "誰に言っている！ 任せろ！"),
    Responce("tsukasa", "rui", "かなり調子いいぞ！", "本当に君は本番に強いねえ！"),
    Responce("rui", "tsukasa", "素晴らしいショーになる予感がするよ！", "ああ、オレもそう思っていた！"),
    //emu
